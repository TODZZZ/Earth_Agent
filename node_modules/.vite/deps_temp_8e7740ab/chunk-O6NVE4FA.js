...
var BasePromptTemplate = class extends Runnable {
  ...
  static async deserialize(data) {
    switch (data._type) {
      case "prompt": {
        const { PromptTemplate: PromptTemplate2 } = await import("./prompt-ANUDQNKM.js");
      ...
      case "few_shot": {
        const { FewShotPromptTemplate } = await import("./few_shot-HVUJ2ILJ.js");
...
var interpolateMustache = (template, values) => mustache_default.render(template, values);
...
mustache/mustache.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-O6NVE4FA.js.map
